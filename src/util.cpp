...
const char * const BITCOIN_CONF_FILENAME = "mtc4ei.conf";
const char * const BITCOIN_PID_FILENAME = "mtc4ei.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MTC4ei";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MTC4ei";
#else
    // Unix
    return pathRet / ".mtc4ei";
#endif
#endif
}
