...
#if defined(NDEBUG)
# error "MTC4ei cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MTC4ei Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MTC4 additional fees, %d delta bytes\n",
