...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mtc4ei-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mtc4ei-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mtc4ei transaction") + "\n" +
              "  mtc4ei-tx [options] -create [commands]   " + _("Create hex-encoded mtc4ei transaction") + "\n" +
              "\n";
