MTC4ei Core version 0.13.3 is now available from:

  <https://download.mtc4ei.org/mtc4ei-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/mtc4ei-project/mtc4ei/blob/0.13/src/chainparams.cpp#L214).
