MTC4ei Core version *0.15.1* is now available from:

  <https://download.mtc4ei.org/mtc4ei-0.15.1/>
...
A number of changes to the way MTC4ei Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mtc4eis per kB (0.00001 MTC4). This is to prepare for dropping the minimum transaction fee to 0.1 mtc4eis per kB (0.0001 MTC4) in the next release.
